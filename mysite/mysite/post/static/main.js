...
function create_post() {
    $.ajax({
        ...
        success : function(json) {
            ...
            $("#talk").prepend("<a href=\"post/"+json.post_id+"\" class=\"list-group-item list-group-item-action flex-column align-items-start\"><div class=\"d-flex w-100 justify-content-between\"><h4 class=\"mb-1\">"+json.title+"</h4><small>"+json.created+"</small></div><p class=\"mb-1\">"+json.body+"</p><small>"+json.user+"</small></a>");
        },
